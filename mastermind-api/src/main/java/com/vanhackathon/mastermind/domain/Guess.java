...
/**
 * Each guess for each player. Describes player's answer, exact and near pens
 * and whether the guess solved the game or not.
 * 
 */
public class Guess {
	...
	public int getExactPens() {
		return exactPens;
	}

	public int getNearPens() {
		return nearPens;
	}
